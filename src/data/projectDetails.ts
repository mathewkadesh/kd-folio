...
export const projectDetails: Record<string, ProjectDetailData> = {
  aptira: {
    ...
    highlights: [
      'Deterministic 5-pillar scoring model — same inputs always produce the same output, fully auditable, scored 0–850',
      'Claude API integration for real-time market signal extraction from live job descriptions',
      'Role-specific gap analysis with a ranked "Top gaps to close" list and a "Next best actions" checklist',
      ...
      'Three-tier Stripe subscription model (FREE / PRO £11.99/mo / Enterprise), GDPR-compliant architecture',
    ],
  ...
  'pappu-dosa': {
    slug: 'pappu-dosa',
    bannerMediaId: 'pappu-dosa-banner',
    screenshotIds: ['pappu-dosa-poster', 'pappu-dosa-screen1', 'pappu-dosa-screen2', 'pappu-dosa-screen3'],
    colorTheme: [
      { name: 'Cream',   hex: '#fdf2dc' },
      { name: 'Pink',    hex: '#e97d99' },
      { name: 'Navy',    hex: '#1c2b4a' },
      { name: 'Teal',    hex: '#1d9a8e' },
    ...
    highlights: [
      'Editorial, scroll-driven "Watch your dosa come to life" storytelling section built on the tawa cooking process',
      'Full menu grid with pricing, dietary tags and bestseller/popular badges',
      'Dual-location finder for Easton and Patchway with directions and per-site online ordering links',
      '"Our Story" section tracing the brand from food-truck origins to two Bristol restaurants',
      'Franchise and catering pathways for future expansion, including an announced Cardiff chapter',
    ],
    role: 'Full-Stack Engineer',
    client: 'Pappu (Bristol)',
    duration: '2 weeks',
  },
