...
export const projects: Project[] = [
  {
    ...
    slug: 'aptira',
    title: 'Aptira',
    tagline: 'Career readiness infrastructure — your skills, verified. 2,400+ job seekers scored.',
    description:
      'Aptira turns skills, proof, and market fit into one verified readiness score employers can trust. Built end-to-end: a deterministic scoring engine (Capability, Evidence, Role Fit, Professional Behaviour, Growth Trajectory) with a transparent methodology — no AI black box, same inputs always produce the same output. React frontend, FastAPI scoring service, Supabase data layer.',
  ...
  },
  {
    ...
    tagline: 'AI social-media management for local businesses',
    description:
      'Full-stack SaaS that helps local businesses manage their social presence. Integrates with the Meta Graph API for post scheduling and analytics, runs AI-generated content suggestions via Claude, and includes a competitor radar built on local search data visualised with Leaflet.',
    stack: ['React', 'Vite', 'TypeScript', 'Supabase', 'Claude API', 'Leaflet', 'Meta Graph API'],
    tags: ['React', 'AI', 'Full-Stack'],
    status: 'in-development',
    statusLabel: '🔵 In Development',
    year: 2026,
    caseStudySlug: undefined,
    mediaId: 'socialpulse-poster',
    featured: true,
  },
  {
    id: 'flood',
  ...
  },
  {
    ...
    slug: 'atlasgym',
    title: 'AtlasGym',
    tagline: 'Gym management SaaS — bookings, memberships, analytics',
    description:
      'Full-featured gym management platform with class booking, membership lifecycle management, staff scheduling, and an analytics dashboard. Built on Supabase with Row Level Security for multi-tenant data isolation and real-time updates.',
    stack: ['React', 'Vite', 'TypeScript', 'Supabase', 'Tailwind', 'Framer Motion'],
    tags: ['React', 'Full-Stack'],
    status: 'building',
    statusLabel: '🟡 Building',
    year: 2026,
    mediaId: 'atlasgym-poster',
    featured: false,
  },
  {
    id: 'faithconnect',
  ...
  },
  {
    ...
    tagline: 'Client-side ML image masking — zero uploads, runs in-browser',
    description:
      'Privacy-first background removal that processes images entirely on-device using TensorFlow.js and a WebGL-accelerated segmentation model. No image ever leaves the browser. Ships as a single-page app with drag-and-drop upload and one-click PNG export.',
    stack: ['React', 'TensorFlow.js', 'WebGL', 'TypeScript'],
    tags: ['React', 'AI'],
    status: 'demo',
    statusLabel: '✅ Demo',
    year: 2026,
    mediaId: 'bgremover-poster',
    featured: false,
  },
]

export const allTags = ['All', 'React', 'AI', 'Full-Stack', 'Node', 'Figma'] as const
